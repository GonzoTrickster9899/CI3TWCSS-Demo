...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex justify-between items-center">
                <h1 class="text-3xl font-bold text-gray-800">Blogs App</h1>
                <a href="#create" 
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p class="mt-1">Create your first blog to get started!</p>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
    ...
    <!-- Load Create Modal -->
    <?php $this->load->view('blogs/modals/create'); ?>

    <!-- Load Edit Modals -->
    <?php foreach ($blogs as $p): ?>
        <?php $this->load->view('blogs/modals/edit', ['blog' => $p]); ?>
    <?php endforeach; ?>
    ...
    <script>
        ...
        function confirmDelete(blogId, blogTitle) {
            Swal.fire({
                icon: 'warning',
                title: 'Delete blog?',
                html: `Are you sure you want to delete <strong>"${blogTitle}"</strong>?<br>This action cannot be undone.`,
                ...
                if (result.isConfirmed) {
                    // Submit via AJAX
                    fetch('<?= site_url('blogs/delete/'); ?>' + blogId, {
                        method: 'POST'
                    })
